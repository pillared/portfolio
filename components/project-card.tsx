...
const ProjectCard: React.FC<{ project: Project }> = ({ project }) => {
  return (
    <Card className="z-0 mx-auto my-6 max-w-lg border border-blue-200 bg-gradient-to-br from-sky-50 to-blue-100 shadow-md transition-all duration-200 hover:shadow-lg dark:border-zinc-700 dark:from-zinc-800 dark:to-gray-900">
      ...
      <CardContent className="space-y-4 text-gray-800 dark:text-gray-400">
        <p className="rounded-md py-2 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800">
          {project.description}
        </p>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-start gap-2 rounded-md p-2 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800">
            {/* <Code2 className="mt-0.5 h-5 w-5 flex-shrink-0 text-indigo-500" /> */}
            <div className="text-base text-zinc-800 dark:text-zinc-400">
              <p>
                <strong className="dark:text-blue-100">Technologies:</strong>{" "}
          ...
          <div className="flex items-start gap-2 rounded-md p-2 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800">
            ...
            <div className="text-base text-zinc-800 dark:text-zinc-400">
              <p>
                <strong className="dark:text-blue-100">Role:</strong>{" "}
                {project.role}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2 rounded-md p-2 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800">
            ...
            <div className="text-base text-zinc-800 dark:text-zinc-400">
              <p>
                <strong className="dark:text-blue-100">Learnings:</strong>{" "}
                {project.learnings}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2 rounded-md p-2 transition-colors hover:bg-slate-50 dark:hover:bg-slate-800">
            ...
            <div className="text-base text-zinc-800 dark:text-zinc-400">
              <p>
                <strong className="dark:text-blue-100">Impact:</strong>{" "}
                {project.impact}
              </p>
            </div>
          </div>
